---
tags: [gate-da, dbms, superkeys, keys, relational-model]
aliases: [superkey, superkey counting]
created: 2026-06-28
source: handwritten
---
...
**Candidate Key (CK):** A *minimal* superkey — no proper subset is also a superkey.

**Key rule:** Every superkey *must contain* at least one candidate key as a subset.
